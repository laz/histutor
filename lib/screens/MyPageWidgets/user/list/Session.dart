          ...
          return Row(
            children: [
              ...
              Container(
                ...
                width: 120,
                child: Text(
                    DateTime.now().isBefore(sessions[idx].sessionStart.toDate())
                        ? '진행 예정'
                        : '진행중',
                    style: TextStyle(
                      fontSize: 15,
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        if (sessions[idx].participants.contains(user.id)) {
                          // if tutoring
                          if (sessions[idx].actualStudentBeingTutored ==
                              user.id) {
                            // do nothing
                          } else {
                            SessionController().updateEntranceTime(
                                user, sessions[idx].sessionIndex.toString());
                          }
                        } else {
                        ...
                        Navigator.of(context)
                          ...
                          return MultiProvider(
                            ...
                            child: Chatting(
                                sessionIndex: sessions[idx].sessionIndex),
                          );
                        }));
                      },
                      style: ButtonStyle(
